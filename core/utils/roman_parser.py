...
class FrequencyAnalyzer:
    ...
    def most_common(self, n: int = 10):
        ...
        logger.info(f"[STEP 2] Fetching top {n} most common values")
    ...
    def dominant(self):
        ...
        logger.info(
            f"[DOMINANT] Value={dominant_value} | Count={count}"
        )
    ...
    def filter_min_frequency(self, min_count: int):
        ...
        logger.info(
            f"[STEP 4] Filtering items with frequency >= {min_count}"
        )
    ...
    def normalize(self):
        ...
        logger.info("[STEP 5] Normalizing frequency values")
